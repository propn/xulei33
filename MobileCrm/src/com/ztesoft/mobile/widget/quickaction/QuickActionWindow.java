...
/**
 * A class that can display, as a popup badge, a collection of QuickActionItems
 * 
...
public class QuickActionWindow extends PopupWindow implements KeyEvent.Callback {
	 ...
	 * @param pView
	 *            The view you want to anchor the window on (the parent)
	 * @param rect
	 *            Rectangle defining the view area
	 */
	 ...
	 *            Icon to be shown
	 * @param text
	 *            Label to be shown below the drawable
	 * @param l
	 *            Definition for the callback to be invoked when the view is
	 *            cliked
	 */
	 ...
	 *            Icon to be shown
	 * @param text
	 *            Label resource id to be shown below the drawable
	 * @param l
	 *            Definition for the callback to be invoked when the view is
	 *            cliked
	 */
	...
	private void showArrow(int whichArrow, int requestedX) {
		...
		final int arrowWidth = mContext.getResources()
	 ...
	 * 
	 * @param requestedX
	 *            The X coordinate the arrow will point at
	 */
