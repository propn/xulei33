package com.ztesoft.mobile.widget.quickaction;
...
public class QuickActionTest extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.quickaction_test);
		...
		b1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				final QuickActionWindow qa = new QuickActionWindow(mContext, v,
						rect);
				...
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_agenda), "agenda",
						new OnClickListener() {
							public void onClick(View v) {
								Toast.makeText(mContext, "agenda",
				...
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_add), "add",
						new OnClickListener() {
							public void onClick(View v) {
				...
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_camera), "camera",
						new OnClickListener() {
							public void onClick(View v) {
								Toast.makeText(mContext, "camera",
										Toast.LENGTH_SHORT).show();
								qa.dismiss();
							}
						});
				...
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_compass), "compass",
						new OnClickListener() {
							public void onClick(View v) {
								Toast.makeText(mContext, "compass",
										Toast.LENGTH_SHORT).show();
								qa.dismiss();
							}
						});
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_crop), "crop",
						new OnClickListener() {
							public void onClick(View v) {
								Toast.makeText(mContext, "crop",
										Toast.LENGTH_SHORT).show();
								qa.dismiss();
							}
						});
				...
				qa.addItem(
						getResources().getDrawable(
								android.R.drawable.ic_menu_help), "help",
						new OnClickListener() {
							public void onClick(View v) {
								Toast.makeText(mContext, "help",
										Toast.LENGTH_SHORT).show();
								qa.dismiss();
							}
						});
